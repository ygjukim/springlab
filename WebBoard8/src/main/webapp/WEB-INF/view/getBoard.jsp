		...
		<form action="updateBoard" method="POST">
			<table>
				...
				<tr>
					...
					<td align="left">
					<c:forTokens var="fileName" items="${board.uploadFiles}" delims="," varStatus="status">
						<c:url value="${uploadDir}/${fileName}" var="url" />
						<a href="${url}" download>${fn:toUpperCase(fileName)}</a>
				...
				<tr>	
					...
					<td align="left"><fmt:formatDate value="${board.regDate}" pattern="yyyy-MM-dd hh:mm:ss" /></td>
				</tr>
				<tr>	
